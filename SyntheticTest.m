...
% save(Synthetic_results.mat','test_ranks','perturbation','S','N','d', 'errorsLR','errorsRandLR','errorsRandOrth','errorsRandOrth_krp', 'timeLR','timeRandLR', 'timeRandOrth','timeRandOrth_krp')
