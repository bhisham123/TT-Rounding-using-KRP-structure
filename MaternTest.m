...
xlim([3,37])
lgd3 = legend(sp3);
% set(lgd3,'Units', 'normalized','Position',[0.3055 0.258664245149759 0.159 0.0670241286863271],'FontSize',12.5)
...
% 
% file_name = "Matern.png";
% exportgraphics(f, file_name,'Resolution', 400)
